...
Source: OpenStax College Physics 2e, Chapter 8, Section 8.4

## Concept explanation
A one-dimensional collision involves two objects moving along the same line. The conservation of momentum principle applies when the net external force on the system is zero.

An elastic collision is a collision that also conserves internal kinetic energy. Internal kinetic energy is the sum of the kinetic energies of the objects in the system.

In practice, truly elastic collisions are found only with subatomic particles, such as electrons striking nuclei. Macroscopic collisions are usually only nearly elastic, because some kinetic energy is converted into other forms of energy such as heat transfer due to friction and sound. Examples of nearly elastic macroscopic collisions include two steel blocks on ice and two carts with spring bumpers on an air track.

To solve one-dimensional elastic collisions between two objects, use both conservation of momentum and conservation of internal kinetic energy.
...
- Momentum and kinetic energy consistency checks
