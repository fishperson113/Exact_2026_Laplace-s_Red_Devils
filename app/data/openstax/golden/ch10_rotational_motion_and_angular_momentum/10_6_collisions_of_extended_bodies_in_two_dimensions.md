...
Source: OpenStax College Physics 2e, Chapter 10, Section 10.6

## Concept explanation
Collisions of extended bodies in two dimensions can involve linear momentum, angular momentum, and energy.

A common example is a disk striking a stick that is nailed at one end to a frictionless surface. After the collision, the disk and stick can rotate together about the nail. In this situation:

- There is an unbalanced external force at the nail.
- That force exerts no torque about the nail because its lever arm is zero.
- Therefore, angular momentum is conserved for the collision.
- Kinetic energy is not conserved because the collision is inelastic.
- Linear momentum may not be conserved, because the force at the nail may have a component in the direction of the disk’s initial velocity.

This section also introduces the point of percussion. If a stick, racquet, or bat is struck at a particular intermediate point, little or no force is delivered to the support hand or nail. This is the point where the effect of the impact produces no force on the pivot or hand. In tennis, this is often called the “sweet spot.” Hitting away from this point can cause the handle to be pushed into or pulled away from the hand.

The section emphasizes that many collisions of everyday objects involve rotation, such as bowling pins, cars on slick surfaces, baseballs with spin, and tennis balls with top spin.
...
The result is that the total linear momentum after the collision is greater than before the collision, because the nail exerts an external force on the system.

## Key concepts used
- Angular momentum conservation about a pivot
- Torque is zero when the lever arm is zero
- Inelastic collision
- Rotational inertia of a rod about one end
- Rotational kinetic energy
- Translational kinetic energy
- Linear momentum of a composite rotating system
- Center of mass motion in a rotating rod
- Point of percussion
- “Sweet spot” in tennis and baseball
