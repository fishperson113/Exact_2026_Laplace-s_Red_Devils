...
strict-format physics prompt from [shared/prompts/system.py](../../shared/prompts/system.py),
...
python -m app.physics_solution.cli.prepare_sample --n 50 --seed 42
...
python -m app.physics_solution.cli.upload_model \
    ...
    --results app/physics_solution/versions/v01_zeroshot_baseline/output/results.json
```

## Expected output

- `output/results.json` — summary + per-row.
- `output/results.csv` — same data in tabular form.
