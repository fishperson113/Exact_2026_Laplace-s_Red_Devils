Sample Problem 25.06
Dielectric partially filling the gap in a capacitor
...
A capacitor consists of two isolated
...
can be associated with the capacitor’s electric field 
By extension
...
2CV2,
2
What is Ceq of three capacitors, each of capacitance C, if they
...
•29
What capacitance is required to store an energy of 10 kW&h
at a potential difference of 1000 V?
•30
How much energy is stored in 1.00 m3 of air due to the “fair
...
•32
A parallel-plate air-filled capacitor having area 40 cm2 and
...
••33
A charged isolated metal sphere of diameter 10 cm has a po-
...
••34
In Fig. 25-28, a potential difference V ! 100 V is applied
...
••55
The space between two concentric conducting spherical shells
...
•52
For the arrangement of Fig. 25-17, suppose that the battery
...
••53
A parallel-plate capacitor has plates of area 0.12 m2 and a
...
••54
Two parallel plates of area 100 cm2 are given charges of
...
63
Two parallel-plate capacitors, 6.0 mF each, are connected
...
75
A capacitor of unknown capacitance C is charged to 100 V and
...
76
A 10 V battery is connected to a series of n capacitors, each of
...
78
You have many 2.0 mF capacitors, each capable of with-
...
80
A capacitor is charged until its stored energy is 4.00 J. A sec-
