...
2
The wire loop in Fig. 30-22a is sub-
...
at every point
of such a loop; the induced emf is related to 
by
(30-19)
...
.
Inductors
An inductor is a device that can be used to produce a
...
(30-31)
Self-Induction
If a current i in a coil changes with time, an emf
...
Series RL Circuits
If a constant emf # is introduced into a sin-
...
(30-45)
Magnetic Energy
If an inductor L carries a current i, the
...
(30-55)
Mutual Induction
If coils 1 and 2 are near each other, a chang-
...
Lenz’s Law
•1
In Fig. 30-33, a circular loop of wire 10 cm
...
the loop?
•2
A certain elastic conducting material is stretched into a cir-
...
coil during 't?
•4
A wire loop of radius 12 cm and re-
...
greatest first.
11
Figure 30-31 shows three situations in which a wire loop lies
...
(b)
•6
Figure 30-37a shows a circuit consisting of an ideal battery
...
magnitude.
12
Figure 30-32 gives four situations in which we pull rectangu-
...
PROBLEMS
by a distance x
R. Consequently, the magnetic field due to the
...
field 
points in the positive x direc-
...
••17
A small circular loop of area 2.00 cm2 is placed in the plane
...
•32
A loop antenna of area 2.00 cm2 and resistance 5.21 m1 is
...
ity . The rails are connected at one
...
•30
In Fig. 30-53a, a circular loop of wire is concentric with a sole-
...
RL Circuits
•50
The current in an RL circuit builds up to one-third of its
...
Self-Induction
•44
A 12 H inductor carries a current of 2.0 A.At what rate must
...
•66
A circular loop of wire 50 mm in radius carries a current of
...
•68
A toroidal inductor with an inductance of 90.0 mH encloses
...
Mutual Induction
•72
Coil 1 has L1 ! 25 mH and N1 ! 100 turns. Coil 2 has L2 !
...
6.70 , and L
5.50 H.The ideal battery is connected at time t
0.
!
!
"
